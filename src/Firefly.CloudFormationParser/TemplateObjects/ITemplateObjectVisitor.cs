namespace Firefly.CloudFormationParser.TemplateObjects
{
    ...
    public interface ITemplateObjectVisitor
    {
        ...
        /// <returns>Implementations should return <c>true</c> to descend into the intrinsic; else <c>false</c> to proceed to next property.</returns>
        bool VisitIntrinsic(ITemplateObject templateObject, PropertyPath path, IIntrinsic intrinsic);
