namespace Firefly.CloudFormationParser.TemplateObjects.Traversal.AcceptExtensions
{
    ...
    /// <summary>
    /// Adds accept methods to <see cref="SubIntrinsic"/>
    /// </summary>
    internal static class SubAcceptExtentsions
    {
        /// <summary>
        ...
        public static SubIntrinsic Accept<TVisitor>(this SubIntrinsic self, TVisitor visitor)
        ...
        public static SubIntrinsic Accept<TContext>(
            this SubIntrinsic self,
