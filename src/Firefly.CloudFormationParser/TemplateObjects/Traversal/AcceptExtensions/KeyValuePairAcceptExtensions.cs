namespace Firefly.CloudFormationParser.TemplateObjects.Traversal.AcceptExtensions
{
    ...
    /// <summary>
    /// Adds accept methods to <see cref="KeyValuePair{TKey,TValue}"/>
    /// </summary>
    internal static class KeyValuePairAcceptExtensions
    {
        /// <summary>
        ...
        public static KeyValuePair<TKey, object> Accept<TKey, TVisitor>(
            this KeyValuePair<TKey, object> self,
            TVisitor visitor)
        ...
        public static KeyValuePair<TKey, object> Accept<TKey, TContext>(
            this KeyValuePair<TKey, object> self,
