namespace Firefly.CloudFormationParser.TemplateObjects.Traversal.AcceptExtensions
{
    ...
    /// <summary>
    /// Adds accept methods to <see cref="AbstractArrayIntrinsic"/>, covering <c>!FindInMap</c>,
    /// <c>!Join</c>, <c>!Split</c>, <c>!GetAtt</c>, <c>!Cidr</c> and all the condition logical functions.
    /// </summary>
    internal static class AbstractArrayIntrinsicExtensions
    {
        /// <summary>
        ...
        public static AbstractArrayIntrinsic Accept<TVisitor>(this AbstractArrayIntrinsic self, TVisitor visitor)
        ...
        public static AbstractArrayIntrinsic Accept<TContext>(
            this AbstractArrayIntrinsic self,
